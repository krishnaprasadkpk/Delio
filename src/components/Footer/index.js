...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font border-t-2">
      <div className="container px-2 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="w-64 text-center md:text-left">
            <a className="flex title-font font-medium items-center justify-center text-gray-900">
              <img
                ...
                alt="Delio Image"
                className="w-10 h-10 p-0.5 bg-indigo-500 rounded-full"
              ></img>
              <span className="ml-3 text-xl">Delio</span>
            </a>
            <p className="mt-2 text-sm text-gray-500 text-center">
              India's Best Ecommerce Platform
            </p>
          </div>
        </div>
